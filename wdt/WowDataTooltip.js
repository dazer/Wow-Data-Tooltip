...
yepnope([{
	test: window.jQuery,
	nope: 'https://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js',
	complete: function () {
		yepnope({
			test: jQuery.qtip,
			nope: 'qtip2/jquery.qtip.min.js',
			complete: function () {
				jQuery(function () {
					
					// --- JavaScript loading complete -------------------------
					
					alert('qtip2 loading done');
